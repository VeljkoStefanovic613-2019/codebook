...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    ...
    password.current.value = process.env.REACT_APP_GUEST_PASSWOR;
    try{
      const authDetail ={
        email: email.current.value,
        password: password.current.value
